  ...
  var Github = function(options) {
    ...
    Github.User = function() {
      this.repos = function(cb) {
        ...
        _requestAllPages("/user/repos?type=owner&per_page=1000&sort=size", function(err, res) {
          cb(err, res);
        });
      };
      ...
      this.ratelimit = function(cb) {
        _request("GET", "/rate_limit", null, function(err, res) {
          cb(err, res);
        });
      };
      ...
      this.userRepos = function(username, cb) {
        // Github does not always honor the 1000 limit so we want to iterate over the data set.
        _requestAllPages("/users/"+username+"/repos?type=public&per_page=1000&sort=size", function(err, res) {
          cb(err, res);
        });
      };
    ...
    Github.Repository = function(options) {
      ...
      this.languages = function(cb) {
        _request("GET", repoPath + "/languages", null, cb);
      };
      ...
      // List repository Fork
      // -------
      this.forklist = function(cb) {
        _request("GET", repoPath + "/forks?page=2&per_page=100", null, cb);
      };
